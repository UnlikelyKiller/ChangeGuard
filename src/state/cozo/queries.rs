...
pub const CREATE_LEDGER_LINK_TABLE: &str = ":create ledger_link { node_id: String, ledger_id: String => interaction_type: String }";
...
pub const CREATE_FTS_INDEX: &str = "::fts create node:fts_idx {extractor: label, tokenizer: Simple}";
